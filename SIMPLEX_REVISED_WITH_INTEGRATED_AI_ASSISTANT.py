...
UI_TRANSLATIONS = {
    "Revised Simplex Pro V9 - CERC Notation / Azure Edition": "Simplex Revizuit Pro V9 - Notație CERC / Ediție Azure",
...
class SimplexInterface:
    ...
    def _apply_language(self):
        self.root.title(self.localize_text("Revised Simplex Pro V9 - CERC Notation / Azure Edition"))
...
""".strip()
    ...
    def _generate_problem_with_repair(self, user_problem):
        ...
        raise ValueError(f"The AI did not return a complete valid JSON problem. Last error: {last_error}")
    ...
    def ask_llm(self, prompt):
        try:
            ...
            self._append_chat_safe(
                f"{self._ui('AI ERROR:')}\n"
                f"Could not generate a complete JSON problem.\n\n"
    ...
    def import_json(self):
        if self.generated_problem is not None:
            ...
            try:
                ...
                messagebox.showerror(
                    ...
                    f"The generated JSON could not be imported.\n\n{exc}"
                )
                return
        else:
        ...
        try:
            ...
            self.app.append_log("Optimization problem imported from AI Assistant.")
            self.app.ai_problem_context = self.last_user_prompt
    ...
    def _build_solution_explanation_prompt(self):
        language_name = "Romanian" if getattr(self.app, "language", "en") == "ro" else "English"
...
""".strip()
    ...
    def ask_solution_explanation(self):
        try:
            ...
            self._append_chat_safe(
                f"AI:\n{fallback}\n\n"
                f"Notă: explicația de mai sus a fost generată local din rezultatele solverului, "
